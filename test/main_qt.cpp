...
int main(int argc, char* argv[]) {
    ...
    TM_RUN_TEST(test_qt_session_exact_request_id_cancel);
    ...
    TM_RUN_TEST(test_qt_stateless_transport_callback_thread_contract);
    ...
    TM_RUN_TEST(test_qt_server_view_call_isolation);
    TM_RUN_TEST(test_qt_logger_level_filtering);
    TM_RUN_TEST(test_qt_logger_file_output);
    TM_RUN_TEST(test_qt_protocol_config_validation);
